...
function makeSeries(seriesIterator, dataType, useR, datums) {
  const start = 0;
...
export class ChartConfig extends React.Component {
  static defaultProps = {
    count: 1,
    resizable: true,
    width: 384,
